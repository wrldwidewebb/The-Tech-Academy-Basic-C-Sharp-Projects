...
namespace SixExercisesAfterIterationTutorial
{
    class Program
    {
        static void Main()
        {
            ...
            Console.WriteLine("Please select and type one of the following bands: Packers, Bucs, Bills, and Chiefs");
            ...
            List<string> names1 = new List<string>() { "Packers", "Bucs", "Bills", "Chiefs" };
